...
INSERT INTO experiences (id, name, category_id, thrill, duration_label, age_label, base_price, price_mode, flat_label, image, blurb, detail, price_rr, price_nr, sort_order) VALUES
  ...
  ('pirate', 'Pirate Ship', 'kids', 1, '15 MIN', '3–12', 350, 'pp', NULL, '/images/pirateship.avif', 'Set sail on gentle thrills: pirate adventures for the smallest buccaneers.', NULL, NULL, NULL, 14),
  ('bonding', 'Bonding Roller Coaster Zipline', 'kids', 2, '15 MIN', '4+ W/ ADULT', 450, 'pp', NULL, '/images/bondingrollercoasterzipline.avif', 'A ride that bonds parents and children: gentle thrills, curves and giggles.', NULL, NULL, NULL, 15),
  ('coaster', 'Roller Coaster Express', 'kids', 2, '10 MIN', '4–12', 450, 'pp', NULL, '/images/rollercoast.avif', 'Twists, turns and laughter aboard the Kids Park’s favourite express.', NULL, NULL, NULL, 16),
  ('playground', 'Outdoor Playground', 'kids', 1, 'OPEN PLAY', '3–12', 250, 'pp', NULL, '/images/outdoorplayground.avif', 'Climb, slide and explore in an imaginative outdoor adventure space.', NULL, NULL, NULL, 17),
  ('miniquad', 'Mini Quad', 'kids', 2, '15 MIN', '6–12', 500, 'pp', NULL, '/images/miniquad.avif', 'Young adventurers steer their own quad on a safe, supervised track.', NULL, NULL, NULL, 18),
  ('miniexc', 'Mini Excavator', 'kids', 1, '15 MIN', '4–12', 400, 'pp', NULL, '/images/miniexcavator.avif', 'Kids dig, scoop and build with their own mini excavator, hands-on play that quietly builds motor skills.', 'Dig, build and play: creative construction fun at kid scale.', NULL, NULL, 19),
...
INSERT INTO package_tier_items (tier_id, text, sort_order) VALUES
  ...
  (3, 'Quad Discovery', 1),
  (3, 'The Peak', 2),
  (3, 'Nepalese Bridge (350 m)', 3),
  (3, 'Mountain Luge Kart (1 ride)', 4),
  (3, 'GoPro rental, full day', 5),
  (4, 'Admission fee', 0),
  (4, 'Quad Discovery', 1),
  (4, 'The Peak', 2),
  (4, 'Nepalese Bridge (350 m)', 3),
  (4, 'Mountain Luge Kart (1 ride)', 4),
  (4, 'GoPro rental, full day', 5),
  (5, 'Admission fee', 0),
  (5, 'Quad Adventure', 1),
  (5, 'The Peak', 2),
  (5, 'Nepalese Bridge', 3),
  (5, 'Mountain Luge Kart (1 ride)', 4),
  (5, 'GoPro rental, full day', 5),
  (6, 'Admission fee', 0),
  (6, 'Exclusive Quad Adventure', 1),
  (6, 'The Peak', 2),
  (6, 'Nepalese Bridge', 3),
  (6, 'Mountain Luge Kart (1 ride)', 4),
  (6, 'GoPro rental, full day', 5);

SELECT setval(pg_get_serial_sequence('package_tiers','id'), 6);

-- package_addons
INSERT INTO package_addons (text, price_label, sort_order) VALUES
  ('Bicycle Zipline', 'S Rs 1,150 · D Rs 2,300', 0),
  ('Stone-cooking lunch', 'S Rs 10,000 · D Rs 18,000', 1),
  ('Discovery Menu lunch', 'Rs 2,300 pp', 2),
  ('Private guide (zipline & quad)', 'Rs 3,500 to 5,000', 3),
  ('Full-day cinematic video', 'Rs 20,000', 4);
